...
--
-- Name: ppl; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.ppl OWNER TO postgres;

--
-- Name: ppl_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.ppl_id_seq OWNER TO postgres;

--
-- Name: ppl_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: soal_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.soal_id_seq OWNER TO postgres;

--
-- Name: soal_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: ppl id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: soal id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: ppl ppl_name_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: ppl ppl_num_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: ppl ppl_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: soal soal_pertanyaan_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: soal soal_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
