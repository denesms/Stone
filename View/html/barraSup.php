...
<html>
    ...
    <body>
        ...
        <div class="container-viewport mb-5" id="navBar" >
                    ...
                    <div class = "collapse navbar-collapse container-fluid" id = "navbarSite">
                        ...
                        <ul class = "navbar-nav ml-auto mr-md-auto">
                            ...
                            if (isset($_SESSION['nomeUser'])) {
                                ...
                                <li class = "nav-item dropdown">
                                    ...
                                    <div class = "dropdown-menu">
                                        ...
                                        <a class = "dropdown-item list-group-item text-success" href = "MeusCursos.php"><i class="fa fa-university fa-lg"></i><strong>&nbsp&nbsp;Meus Cursos</strong></a>
                                        <a class = "dropdown-item list-group-item text-info" href = "NotasF.php"><i class="fa fa-mortar-board fa-lg"></i><strong>&nbsp&nbsp;Notas</strong></a>
                                        <a style="color:#7d15bd; " class = "dropdown-item list-group-item" href = "#"> <img style="width:23px; height: 18px;" src="../img/certificate-diploma.png" alt=""/> <strong>&nbsp&nbsp;Certificados</strong></a>
                            ...
                            <?php } elseif (@$_SESSION['permissao'] == 'Professor') { ?>
                                <a class = "nav-link text-white ml-5"style="padding-left: 100px" href = "professorF.php" ><strong>Professor</strong></a>
                            <?php } ?>
